...
class Config():
    def __init__(self):
        ...
        self.save_path = "/home/kuanli/Documents/ros2_ws/src/mocap_ws/src/mocap/data_analyze/data/"
        ...
        self.arm_l = [[-2.88,2.88], [-0.175, 2.2515], [-2.618, 2.618], [-2.2166, 0.2443], [-2.618, 2.618], [0, 0], [0, 0]]
        self.arm_r = [[-2.88,2.88], [-2.2515, 0.175], [-2.618, 2.618], [-0.96, 2.2166], [-2.618, 2.618], [0, 0], [0, 0]]
