...
if __name__ == "__main__":
    ...
    l_frame = pin.Frame(
        "barrier_l",
        robot.model.getJointId("joint_la7"),
        robot.model.getFrameId("link_la7"),
        l_frame_placement,
    ...
    r_frame = pin.Frame(
        "barrier_r",
        robot.model.getJointId("joint_ra7"),
        robot.model.getFrameId("link_ra7"),
        r_frame_placement,
        pin.FrameType.OP_FRAME,
    )
    ...
    while True:
        ...
        lb = configuration.get_transform_frame_to_world("barrier_l")
        rb = configuration.get_transform_frame_to_world("barrier_r")
